        ...
        {partnerTypes.map((type) => {
          ...
          return (
            <button
              ...
              className="group relative bg-white dark:bg-gray-800 backdrop-blur-xl rounded-2xl px-6 py-6 border-2 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm hover:shadow-xl transition-all duration-300 hover:scale-[1.03] hover:-translate-y-2 min-h-[240px] flex-1 basis-0"
            >

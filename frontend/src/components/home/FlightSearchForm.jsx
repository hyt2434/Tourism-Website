  ...
  return (
    <div>
      ...
      <div className="relative mb-6">
        <form
          ...
          className="flex  flex-row gap-2 md:gap-3 items-stretch md:items-center"
        >
          <input
            type="text"
    ...
    "
          >
            ...
            <span className="hidden md:inline">{translations.search}</span>
          </button>
        </form>
          ...
          <div className="absolute top-full mt-4 left-1/2 -translate-x-1/2 w-full max-w-6xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 z-50 border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-col items-center justify-center w-full">
              ...
              <div className="flex flex-wrap justify-center items-end gap-4 w-full">
                {/* From */}
                <div
                  className="flex-shrink-0 from-dropdown-container"
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      <input
                        type="text"
                        value={
                          fromSearchQuery || formatCityName(fromLocation) || ""
                        }
                        onChange={(e) => {
                ...
                {/* To */}
                <div
                  className="flex-shrink-0 to-dropdown-container"
                  style={{ minWidth: "180px", maxWidth: "200px" }}
                >
                  <label className="block text-xs text-gray-700 dark:text-gray-300 mb-2 font-medium whitespace-nowrap">
                    {translations.to}
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      <input
                        type="text"
                        value={
                          toSearchQuery || formatCityName(toLocation) || ""
                        }
                        onChange={(e) => {
                          const value = e.target.value;

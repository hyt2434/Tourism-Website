export default {
    ...
    contactProviderDesc: "Có câu hỏi về tour này? Đội ngũ của chúng tôi sẵn sàng giúp bạn lên kế hoạch cho chuyến đi hoàn hảo.",
    callPhone: "Gọi điện",
    liveChat: "Chat trực tiếp",
    tip: "Mẹo",
    bookingTip: "Đặt trước ít nhất 2 tuần để có lựa chọn tốt nhất về chỗ trống và giá cả. Đội ngũ của chúng tôi có thể tùy chỉnh tour này theo sở thích của bạn!",
    // Địa điểm
    hanoi: "Hà Nội",
    hcm: "TP Hồ Chí Minh",
    danang: "Đà Nẵng",
    ...
    moderationNotice: "Bài viết của bạn sẽ được kiểm duyệt trước khi hiển thị công khai. Vui lòng không đăng nội dung vi phạm hoặc thông tin nhạy cảm.",
    media: "Ảnh/Video",
    ...
    privacyNotice: "Quyền riêng tư: Hồ sơ của bạn chỉ hiển thị tên và ảnh đại diện. Thông tin cá nhân khác sẽ được ẩn.",
    cancel: "Hủy",
    post: "Đăng bài",
    ...
    discountFlightDesc: "Áp dụng cho tất cả các lần đặt vé máy bay đầu tiên ứng dụng Traveloka.",
    discountHotelTitle: "Giảm đến 8% cho lần đặt phòng khách sạn đầu tiên.",
    discountHotelDesc: "Áp dụng cho tất cả các lần đặt phòng khách sạn đầu tiên ứng dụng Traveloka.",
    discountActivityTitle: "Giảm đến 6% cho lần đặt vé tham quan/hoạt động đầu tiên.",
    discountActivityDesc: "Áp dụng cho tất cả các lần đặt vé tham quan/hoạt động đầu tiên ứng dụng Traveloka.",
    copy: "Sao chép",
    ...
    review1: "Trải nghiệm tuyệt vời! Chuyến đi được tổ chức chu đáo và thoải mái.",
    review2: "Điểm đến đẹp và hướng dẫn viên thân thiện. Rất đáng để thử!",
    review3: "Giá trị tuyệt vời so với chi phí. Thích nhất là thuyền hoa đăng ở Hội An!",
